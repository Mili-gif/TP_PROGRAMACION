...
void cargarDatosEnElRegistro(registroPersona_t cliente[MAX_CLIENTES],int cont)
{
    ...
    do
    {
        ...
        EsNombreValido=verificarNombreApellido(cliente[cont].nombres, cont);
        //
    }while(!EsNombreValido);//El ! significa "NO"
    //fflush(stdin);
    do
    {
        barraSeparadora();
        ...
        EsNombreValido=verificarNombreApellido(cliente[cont].apellido, cont);
    }while(!EsNombreValido);//El ! significa "NO"
    barraSeparadora();
    fflush(stdin);//Limpio
    ...
    switch(opcionDocumento)
    {
        case DNI:
            ...
            }while(!EsDniValido);//El ! significa "NO"
        break;
        case PASAPORTE:
            do{
                cliente[cont].tipoDocumento= opcionDocumento;
            ...
            }while(!EsPasaporteValido);//El ! significa "NO"
    ...
    } while (!EsProvinciaValida);//El ! significa "NO"
    barraSeparadora();
    fflush(stdin);
    ...
    }while(!EsCalleValida);//El ! significa "NO"
    fflush(stdin);//Limpio
    do
    {   
        barraSeparadora();
    ...
    } while (!EsAlturaValida);//El ! significa "NO"
    //fflush(stdin);
    do
    {
        barraSeparadora();
    ...
    }while(!EsMailValido);//El ! significa "NO"
    fflush(stdin);//Limpio
    do
    {
        barraSeparadora();
    ...
    }while(!EsCelularValido);//El ! significa "NO"
    ...
    }while(!EsClaveMobileValido);//El ! significa "NO"
    barraSeparadora();
    fflush(stdin);//Limpio
...
{
    int banderaValidaCelular=0, aux2=0;
